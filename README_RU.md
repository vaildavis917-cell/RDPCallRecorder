...
- **Автоматическое обнаружение звонков** — мониторит процессы WhatsApp, Telegram и Viber на наличие **реального аудиовыхода** (не просто активной сессии)
...
2. Каждые 2 секунды проверяет, есть ли у WhatsApp/Telegram/Viber **реальный аудиовыход** (через IAudioMeterInformation)
3. Если звук обнаружен **несколько циклов подряд** (StartThreshold) — значит это звонок, а не уведомление:
...
| Порог старта | Сколько опросов с аудио до начала записи (защита от уведомлений) | 2 |
